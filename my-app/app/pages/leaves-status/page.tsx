...
export default function LeaveStatusPage() {
    const [leaveRequests, setLeaveRequests] = useState<LeaveStatusItem[]>([]);
    ...
    const fetchLeaveStatus = async () => {
        try {
            ...
            const result = await getLeaveStatusList({ byUserId: user.id });
            setLeaveRequests(result?.responseData?.leaves?.data ?? []);
        } catch (error) {
            console.error(error);
        ...
        <div className="min-h-screen p-4 md:p-8">
            <div className="max-w-6xl mx-auto">
                <div className="mb-8 border-l-4 border-blue-600 pl-4">
                    <h1 className="text-2xl font-bold text-gray-800">Leave Status</h1>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-16 gap-3">
                            ...
                            <p className="text-gray-500 text-sm">Loading leave status...</p>
                        </div>
